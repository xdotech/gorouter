// Package domain defines the core business models for gorouter.
// These types are used by all layers — they carry JSON tags for API serialization.
package domain
...
// ProviderNode is a custom OpenAI/Anthropic-compatible endpoint.
...
// DefaultSettings returns safe default values.
